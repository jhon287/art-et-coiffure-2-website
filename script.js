...
function applyTranslations(translations) {
  ...
  setText('labelFacebook', "Facebook:");
...
function applyData(data, language) {
  ...
  const facebookHref = data.contact.facebook.url ? data.contact.facebook.url : '#';
  const facebookText = data.contact.facebook.text ? data.contact.facebook.text : 'Facebook';
  ...
  setLink('contactFacebook', facebookHref, facebookText);
